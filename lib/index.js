...
export function apply(ctx) {
    ctx.tools.register(defineTool({
        ...
        description: 'Search for DeepSeek Harness plugins. Two tiers: curated results from the human-verified ' +
        ...
        parameters: {
            ...
            scope: {
                type: 'string',
                description: "'curated' searches only the verified registry; 'all' always adds the GitHub community tier. " +
